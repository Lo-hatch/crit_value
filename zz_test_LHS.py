...
if __name__ == '__main__':
 ...
 "SE-Nor" ,"CN-Cng" ]
    ...
    outfile = f"{fout}zz_test_LHS.xlsx"
    snd = {
    ...
    tag = f'{sitetag}_NTD'
    params_data = pd.read_csv(f'{fout}lhs_samples_50new.csv')
    # snd = {
        ...
        for imethod in calc_methods:
            ...
            for iseg in [3]:
                for ikey,imod in snd.items():
                    ...
                    for itest in [15,20]:#range(3,5,1):
                        ...
                        # iftextfrac=False,prc=1,tit =tit,x_lim=['2003-06-01','2003-09-30'],y_lim=y_lim,ify2=True,var2='wb_soilmean',y_lim2=y_lim2)  
                            ...
                            iplot,xcmx,xccmx,xccmn,r,rmse,xcons1,xcons2,xcons3,xslope1,xslope2,xslope3,xcons3K = self.plot_scatter(X,Y,xlab,ylab,'logi',
                                iplot,oneline=False,ifcolor=False,iffit = True,clcvar=clcvar,clcpro=clcpro,tit =f'{tit}' ,y_lim=(0,1),x_lim = x_lim1,
                                ifsigma=True)
                            # NTD90 = NTD_stat(Y)
