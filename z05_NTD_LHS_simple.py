...
class PlotIt(mcPlot):
    ...
    def plot_scatter(self, xx,yy,xlab,ylab,fitname, iplot, oneline=False, ifcolor=True, iffit = False,clcvar=None, clcpro = None, x_lim=None,y_lim=None, tit=None, fitDirec=True, GM_method=None):
...
if __name__ == '__main__':
 ...
 "SE-Nor" ,"CN-Cng" ]
    ...
    outfile = f"{fout}result_BASEdc98fe39_LHS_simple.xlsx"
    snd = {
        ...
        for imethod in calc_methods:
            ...
            for iseg in [3]:
                for ikey,imod in snd.items():
                    ...
                    for itest in [46,15]: #range(1,51,1):
