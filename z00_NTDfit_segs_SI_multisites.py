    ...
    def plot_scatter(self, xx,yy,xlab,ylab,fitname, iplot, oneline=False, ifcolor=True, iffit = False,clcvar=None, clcpro = None, x_lim=None,y_lim=None, tit=None, fitDirec=True, GM_method=None):
        ...
        if iffit:
            ...
            for i, (xx, yy) in enumerate(zip(X, Y)):
                ...
                value = xslope2
                line1,=ax1.plot(x_fit, y_fit_kernel, color=cmap(i),linestyle='-',label='fitting line',linewidth=1.5)
        ...
        transform=ax1.transAxes, fontsize=7,color=cmap(i))
            ...
            y_fit_kernel,xcons3K =my_af.kernelRegression(xx,yy)
            value = xslope2
            line1,=ax1.plot(x_fit, y_fit_kernel, color='k',linestyle='-',label='fitting line',linewidth=1.5)
                ...
                for ikey,imod in snd.items():
                    ...
                    for ix, xlab in varsoil.items():
                        ...
                        iplot,xcmx,xccmx,xccmn,r,rmse,xcons1,xcons2,xcons3,xslope1,xslope2,xslope3,xcons3K = self.plot_scatter(X,Y,xlab,ylab,'logi',
                            iplot,oneline=False,ifcolor=False,iffit = True,clcvar=clcvar,clcpro=clcpro,tit =f'{tit}: logi' ,y_lim=(0,1),x_lim = x_lim1)
