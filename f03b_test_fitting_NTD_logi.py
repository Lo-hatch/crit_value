...
class PlotIt(mcPlot):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.nrow     = 6     # # of rows of subplots per figure
...
if __name__ == '__main__':
 ...
 "SE-Nor" ,"CN-Cng" ,"CN-Dan"]
    sites = ["US-SRM" ,  "CA-SF2","IT-Cp2" ,"FR-LBr", "CN-Qia",
            ]
    ...
    if drydown:
        ...
        segs = [0,1,2,3,4]
        segs = [3]
        outfile = f"{fout}result_BASEdc98fe39_depth.xlsx"
...
# Extract the two 'xxxx' parts before the .nc extension
    ...
    for isite in sites:
        ...
        for ikey,imod in snd.items():
            ...
            fn = glob.glob(f'{fp1}{isite}/{varlab0}/{imod}/outputs/site_out_cable_*.nc')
