...
class PlotIt(mcPlot):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dyabc    = 1.06  # % of (max-min) shift up from lower x-axis
                              # for a,b,c,... labels
        # legend
        self.llxbbox    = 0.63  # x-anchor legend bounding box
    ...
    def plot_scatter(self, xx,yy,xlab,ylab,fitname, iplot, oneline=False, ifcolor=True, iffit = False,clcvar=None, clcpro = None, x_lim=None,y_lim=None, tit=None, fitDirec=False, GM_method=None):
        ...
        if ifcolor:
            ...
            my_pf.plot_scatter_cmap(xx,yy,clcvar,xlab,ylab,clcpro = clcpro, sz = 8,clcbarpad = 0.06,clcbarloc='top',ax1=ax1,fig = fig,ifcolorbar=(iplot==1))
        else:
        ...
        if iffit:
            ...
            if fitname=='logi':
                r, rmse, x_fit,y_fit,best,y2,bestylab,y_3d,x_3d,y_c,xcmx,xcmn1,y_cc, xccmx1,xccmn1,dycmx,dyccmx,dyccmn= my_af.logistic_fitting(xx,yy,fitDirec=fitDirec,GM_method=GM_method)
            elif fitname=='tanh':
            ...
            ax1.text(0.02+0*0.16,0.9-0*0.1, f'R2={txt},RMSE={my_pf.numstrFormat(rmse,2)}' ,verticalalignment='bottom', horizontalalignment='left',
            ...
            line2=ax1.axvline(x=xcmx, color=dark_grey, linestyle=':',label='max curvature')
            line3=ax1.axvline(x=xccmx1, color=light_grey, linestyle='--',label='max curvature change')
            line4=ax1.axvline(x=xccmn1, color=light_grey, linestyle=':',label='min curvature change')
            ...
            if best>x_3d:
                ...
                clc = 'g'
            clc = 'r'
            ax1.text(0.02+0*0.16,0.9-1*0.08, f'Max curvature={my_pf.numstrFormat(xcmx,2)}' ,verticalalignment='bottom', horizontalalignment='left',
            transform=ax1.transAxes, fontsize=6)
            ax1.text(0.02+0*0.16,0.9-2*0.08, f'Max curvature change={my_pf.numstrFormat(xccmx1,2)}' ,verticalalignment='bottom', horizontalalignment='left',
            transform=ax1.transAxes,fontsize=6)
            ax1.text(0.02+0*0.16,0.9-3*0.08, f'Min curvature change={my_pf.numstrFormat(xccmn1,2)}' ,verticalalignment='bottom', horizontalalignment='left',
            transform=ax1.transAxes, fontsize=6)
            ax2 = ax1.twinx()
            line5,=ax2.plot(x_fit,y_c,color=dark_grey, linestyle='-',label='curvature')
            ...
            line6,=ax3.plot(x_fit, y_cc, color=light_grey, linestyle='-', label='curvature change')
        ...
        if iplot==1:
            lines = [line1, line5,line6,line2,line3,line4]
            ...
            ll = ax1.legend(lines,labels,frameon=self.frameon, ncol=1,
                            ...
                            scatterpoints=1, numpoints=1,fontsize=4.6)
...
if __name__ == '__main__':
 ...
 "SE-Nor" ,"CN-Cng" ,"CN-Dan"]
    ...
    if platform.node()=='zlhp':
        ...
        fout = '/mnt/d/project/hydraulic/test/plot/f03_test_fitting/'
    ...
    snd = {
        'fine clay': 'newRNumtag_Stype3_Vtype1_newBAI_oldvcmax',
        'silty clay': 'newRNumtag_Stype6_Vtype1_newBAI_oldvcmax',
        'clay loam': 'newRNumtag_Stype2_Vtype1_newBAI_oldvcmax',
        'sandy clay': 'newRNumtag_Stype5_Vtype1_newBAI_oldvcmax',
        'sandy clay loam':'newRNumtag_Stype7_Vtype1_newBAI_oldvcmax',
        'Sandy loam': 'newRNumtag_Stype4_Vtype1_newBAI_oldvcmax',
        'sand':'newRNumtag_Stype1_Vtype1_newBAI_oldvcmax',
            }
    snd = {'TotalEstVap fine clay': 'switch2_totalEstVap_wbHow_psilxm_Stype3_Vtype1',
            'newR fine clay':'newRNumtag_Stype3_Vtype1_newBAI_oldvcmax_1990_2021'
            }
    snd = {'fine clay': 'Ratio_maximum_Bfr_Stype3_Vtype1',
           'silty clay': 'Ratio_maximum_Bfr_Stype6_Vtype1',
           'clay loam': 'Ratio_maximum_Bfr_Stype2_Vtype1',
           'sandy clay':'Ratio_maximum_Bfr_Stype5_Vtype1',
           'sandy clay loam':'Ratio_maximum_Bfr_Stype7_Vtype1',
           'Sandy loam': 'Ratio_maximum_Bfr_Stype4_Vtype1',
           'sand':'Ratio_maximum_Bfr_Stype1_Vtype1',
           }
    snd = {'fine clay 0.5': 'Ratio_maximum_Bfr0p5_LAImax_Stype3_Vtype1',             
           'fine clay 0.5 LAI LBr': 'Ratio_maximum_Bfr0p5_LAImax_LBr_Stype3_Vtype1',
           'fine clay 1': 'Ratio_maximum_Bfr1_LAImax_Stype3_Vtype1',             
           'fine clay 1 LAI LBr': 'Ratio_maximum_Bfr1_LAImax_LBr_Stype3_Vtype1',
           'fine clay 1.5': 'Ratio_maximum_Bfr1p5_LAImax_Stype3_Vtype1',             
           'fine clay 1.5 LAI LBr': 'Ratio_maximum_Bfr1p5_LAImax_LBr_Stype3_Vtype1',
           'fine clay 2': 'Ratio_maximum_Bfr2_LAImax_Stype3_Vtype1',             
           'fine clay 2 LAI LBr': 'Ratio_maximum_Bfr2_LAImax_LBr_Stype3_Vtype1'}
    snd = {
        'Bf2': 'Ratio_maximum_Bfr2_LAImax_Stype3_Vtype1',
        'Bf2 fwpsim': 'Ratio_maximum_Bfr2_fwpsim_LAImax_Stype3_Vtype1',
        'Bf2 fwpsimOri': 'Ratio_maximum_Bfr2_fwpsimOri_LAImax_Stype3_Vtype1',
        'shoot fwpsimOri': 'shoot_maximum_fwpsimOri_Stype3_Vtype1',
            }
    snd = {
        #'Bf2 fwpsim': 'Ratio_maximum_Bfr2_fwpsim_LAImax_Stype3_Vtype1',
        'Bf2 fwpsim K>5': 'Ratio_maximum_Bfr2_fwpsimk5_LAImax_Stype3_Vtype1',

            }
#    snd = {
#        'fine clay': 'NewRNumtag_wbLAIHow_Stype3_Vtype1_newBAI_oldvcmax',
#         'silty clay': 'NewRNumtag_wbLAIHow_Stype6_Vtype1_newBAI_oldvcmax',
#         'clay loam': 'NewRNumtag_wbLAIHow_Stype2_Vtype1_newBAI_oldvcmax',
#         'sandy clay': 'NewRNumtag_wbLAIHow_Stype5_Vtype1_newBAI_oldvcmax',
#         'sandy clay loam':'NewRNumtag_wbLAIHow_Stype7_Vtype1_newBAI_oldvcmax',
#         'Sandy loam': 'NewRNumtag_wbLAIHow_Stype4_Vtype1_newBAI_oldvcmax',
#         'sand':'NewRNumtag_wbLAIHow_Stype1_Vtype1_newBAI_oldvcmax',
#             }
    snd = {
    ...
    vars=['GPP','Qle']     
    varread = ['Rainf','kplant','kroot','ksoil','GPP','Qle','Qh','SoilMoist','gsw_sl','gsw_sh',
                'sand','clay','silt','psix','psi_can_sl','psi_soil','SoilMoistPFT',
                'ksoilmean','krootmean','kbelowmean','psi_soilmean','wb_soilmean','psi_rootmean','Rnet','SWdown',
                'epotcan3','TVeg','wb_30','psi_30','wb_fr_rootzone','psi_fr_rootzone','epotvpd','leaf_to_air_vpd','rwc_soilmean',
                'rwc_soilmean_recal','gsw_epotcan3_sl','gsw_epotvpd_sl','GPP_epotcan3','gsw_ref_sl']
    varread=['GPP','GPP_epotcan3','TVeg','epotcan3','gsw_sl','gsw_epotcan3_sl','wb_soilmean','rwc_soilmean_recal',]
    suffobs = '_flux.nc'
    varsoil = {
    'wb_soilmean': r'$\theta$ (m m$^{-1}$)', #'mean soil water content (m m$^{-1}$)',
    ...
    #'wb_fr_rootzone':'mean soil water content in rootzone (m m$^{-1}$)',
    #'psi_fr_rootzone':'mean soil water potential in rootzone (Mpa)'
    }
...
# Extract the two 'xxxx' parts before the .nc extension
    ...
    for isite in sites:
        ...
        for isn in shortnames:
            ...
            #tit=f'{isite}: {isn} ({sand:.2f}, {silt:.2f}, {clay:.2f})'
            #self.tit = tit
            ############# use hourly data
            ...
            plot_config = {
                ...
                #    'ylab': r'$\frac{(GPP_{wb}-GPP)}{GPP_{wb}}$',
                #    'ylim': (-0.55, 1.5)
                # },
                # 'Edemand - TVeg': {
                #     'var': (epotcan3-Tveg),
                ...
                for ix, xlab in varsoil.items():
                    ...
                    for imethod in calc_methods:
                        for iseg in [3]:
                            ...
                            iplot,xcmx,xccmx,xccmn,r,rmse,dycmx,dyccmx,dyccmn = self.plot_scatter(xx,yy,xlab,ylab,'logi',iplot,oneline=False,ifcolor=False,iffit = True,clcvar=clcvar,clcpro=clcpro,tit =tit ,fitDirec=True)
                   
                            result.append([ix,isn,ylabel,imethod,iseg,xcmx,xccmx,xccmn,r,rmse,dycmx,dyccmx,dyccmn])
    #    df = pd.DataFrame(result, columns=["Xname", "soiltype","yvar","method",'segID',"MaxCur","MaxCurChange","MinCurChange",'R2','RMSE',"DyMaxCur","DyMaxCurChange","DyMinCurChange"])
        #df.to_excel("results.xlsx", index=False)
     #   with pd.ExcelWriter(f"{fout}result.xlsx", mode="a", engine="openpyxl", if_sheet_exists="replace") as writer:
      #      df.to_excel(writer, sheet_name=f'{isite}_iVeg1_1993_2021', index=False)
