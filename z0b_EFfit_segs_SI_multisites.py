    ...
    def plot_scatter(self, xx,yy,xlab,ylab,fitname, iplot, oneline=False, ifcolor=True, iffit = False,clcvar=None, clcpro = None, x_lim=None,y_lim=None, tit=None, fitDirec=False, GM_method=None):
        ...
        if ifcolor:
            ...
            for i, (xx, yy) in enumerate(zip(X, Y)):
                ...
                if iffit:
                    if fitname=='linear-plateau':
                        ...
                        labtxt = f'{lab}: {my_pf.numstrFormat(value,2)}, R2={txt}, RMSE={my_pf.numstrFormat(rmse,2)}'
                        ...
                        scatter_handles.append(sc)
                        ax1.text(xpos,ypos-i*xinte, labtxt ,verticalalignment='bottom', horizontalalignment='left',transform=ax1.transAxes, fontsize=7,color=cmap(i))
            ...
            if r<0.01:
                ...
                txt = f'{my_pf.numstrFormat(r,2)}'
            labtxt = f'whole: {my_pf.numstrFormat(value,2)}, R2={txt}, RMSE={my_pf.numstrFormat(rmse,2)}'
            ...
            scatter_handles.append(sc)
            ax1.text(xpos,ypos-(i+1)*xinte, labtxt ,verticalalignment='bottom', horizontalalignment='left',transform=ax1.transAxes,color='k')
